...
public class Dosen implements Serializable {
    ...
    @OneToMany(mappedBy = "dosenPengajar")
    private Collection<MataKuliah> mataKuliahCollection;
    ...
    public Collection<MataKuliah> getMataKuliahCollection() {
        return mataKuliahCollection;
    }

    public void setMataKuliahCollection(Collection<MataKuliah> mataKuliahCollection) {
        this.mataKuliahCollection = mataKuliahCollection;
    }
