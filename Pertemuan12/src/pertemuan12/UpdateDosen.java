...
public class UpdateDosen extends javax.swing.JDialog {
    ...
    public UpdateDosen(Frame parent, boolean modal, String idLama, String namaDosenlama, String nipLama, String emailLama) {
        super(parent, modal);
        initComponents();
        connect();
        ...
        cekRelasi.setParameter("idDosen", idLama);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (txtKode.getText().equals("")) {
            ...
            try {
                ...
                query.setParameter("idDosen", idLama);
                query.setParameter("namaDosen", namaDosenlama);
                query.setParameter("nip", nipLama);
                query.setParameter("email", emailLama);
                ...
                if (!hasil.isEmpty()) {
                    ...
                    d.setIdDosen(txtKode.getText());
                    d.setNamaDosen(txtNama.getText());
                    d.setNip(txtSemester.getText());
                    d.setEmail(jTextField1.getText());
