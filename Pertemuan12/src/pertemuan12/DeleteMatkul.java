...
public class DeleteMatkul extends javax.swing.JDialog {
    ...
    public DeleteMatkul(Frame parent, boolean modal, String[] kodeLama, String[] namaLama, String[] semesterLama, String[] dosenLama) {
        super(parent, modal);
        initComponents();
        connect();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            ...
            for (int i = 0; i < kodeLama.length; i++) {
                ...
                query.setParameter("sks", Integer.parseInt(semesterLama[i]));
                query.setParameter("dosen", dosenLama[i]);
