...
public class InsertDosen extends javax.swing.JDialog {
    ...
    public InsertDosen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        connect();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Isi Data Dosen");
        ...
        jLabel2.setText("Nama Lengkap Dosen");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (txtKode.getText().equals("")) {
            ...
            try {
                ...
                d.setEmail(jTextField2.getText());
